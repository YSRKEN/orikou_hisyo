...
　　・大破チェック
　　　　艦これの画面が戦果報告で、その際に大破艦が存在していた場合、
　　　　進撃ボタンを隠す形で白い枠が表示されます。なお、このチェックを外すか
　　　　進撃ボタンの画面以外の画面に移行すれば解除されます。
　　・画面クロップ
