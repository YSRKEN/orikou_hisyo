...
　また特殊な機能として、改装画面でのスクショを利用した「装備まとめ画像作成機能」と、
母港・マップ・戦闘画面において「BGMを自動で流せる機能」を付けました。
...
7.　以下、他のチェックボックス等について説明します。
　　・大破チェック……戦果報告の画面で大破艦が存在していた場合、ダイアログで
　　　　　　　　　　　警告メッセージが表示される。大破進撃は「ダメ・ゼッタイ」！
　　・名前隠し……母港・戦績・戦果等の場面で提督名を隠す機能
　　・倍率～％……サブ画面のサイズを変更できる機能。100・75・50％表示にする
　　　　　　　　　ことができる。なお、画像保存時はこの表示サイズに従うので注意。
...
　ブラウザが100％表示の時以外に使えないのも認識アルゴリズムの仕様です。
